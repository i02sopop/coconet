 Instalación de coconet
========================

Copyright (C) 2011 proyecto coconet (consulte AUTHORS.es)

Este fichero es documentación libre; el proyecto coconet te da permiso
ilimitado para copiarlo, distribuirlo y modificarlo.

Este documento explica todos los pasos necesarios para instalar
coconet. El documento está estructurado en las siguientes secciones:
